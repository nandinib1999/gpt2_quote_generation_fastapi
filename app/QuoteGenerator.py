...
class QuoteGenerator:
    ...
    def generate_quote(self, prompt_start: str, min_length=3, max_length=25, top_p=0.9):
        ...
        quote_gen = self.quote_generator(prompt_start.strip(), min_length = min_length, max_length = max_length, temperature = 1.0, top_k = 0, top_p = top_p)
